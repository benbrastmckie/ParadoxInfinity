...
\begin{twentyshort}
  ...
  \twentyitemshort{30\%}{Short Essays (3 assignments at \%10 each)}
  \twentyitemshort{24\%}{Recitation Attendance (12/14 meetings at \%1 each)}
  \twentyitemshort{6\%}{Pop Quizzes (3 quizzes at \%2 each)}
\end{twentyshort}
